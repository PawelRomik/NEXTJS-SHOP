		...
		try {
			...
			return (
				<motion.section
					...
					id="others"
					className="flex w-full flex-col overflow-y-hidden bg-black  p-3 text-white "
				>
					<div className="relative w-full overflow-hidden lg:static lg:flex-1">
						<div className="flex gap-6 overflow-x-auto py-2 lg:static lg:grid lg:grid-cols-[1fr_1fr_1fr_1fr_0.5fr]">
							...
							>
								<button className="text-1xl group flex h-full  w-full flex-col items-center justify-center border-[4px] border-zinc-900 font-bold uppercase transition hover:border-red-600">
