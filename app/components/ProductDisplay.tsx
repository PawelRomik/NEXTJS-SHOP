...
export default function ProductDisplay({ name, price, imageUrl, category }: ProductDisplayProps) {
	return (
		<div className="group flex cursor-pointer flex-col items-center justify-center">
			<div className="relative flex bg-zinc-100 p-8">
				<Image src={imageUrl} alt={name} className="transition group-hover:scale-105" />
