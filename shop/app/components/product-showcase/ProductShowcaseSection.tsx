...
import ProductPrice from "../product-price/ProductShowcasePrice";
import ProductGallery from "../product-gallery/ProductGallery";
import ProductShowcasePrice from "../product-price/ProductShowcasePrice";
	...
	return (
		...
		>
			<div className="flex flex-[60%] items-center justify-center pt-12">
				<ProductGallery productId={productId} locale={locale} />
			</div>
