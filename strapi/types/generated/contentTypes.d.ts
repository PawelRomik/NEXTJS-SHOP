...
export interface ApiConvertionrateConvertionrate extends Schema.CollectionType {
  collectionName: 'convertionrates';
  info: {
    singularName: 'convertionrate';
    pluralName: 'convertionrates';
    displayName: 'convertionrate';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::convertionrate.convertionrate',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFancywordFancyword extends Schema.CollectionType {
  ...
  info: {
    singularName: 'fancyword';
    pluralName: 'fancywords';
    displayName: 'Fancyword';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiFilterFilter extends Schema.CollectionType {
  ...
  attributes: {
    category: Attribute.Relation<
      ...
      'api::category.category'
    >;
    tags: Attribute.Relation<'api::filter.filter', 'oneToMany', 'api::tag.tag'>;
    name: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    technical: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    fancywords: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::fancyword.fancyword'
    >;
